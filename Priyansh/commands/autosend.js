...
const messages = [
    ...
    { time: '2:00 PM', message: '──── •💜• ──── 𝐍𝐨𝐰 𝐢𝐭𝐬 𝐭𝐢𝐦𝐞 2:00 𝐏𝐌 ⏳ 𝐁𝐨𝐥𝐨 𝐀𝐋𝐋𝐀𝐇 𝐎 𝐀𝐊𝐁𝐀𝐑 💖😇 ──── •💜• ────' },
    ...
    { time: '6:00 PM', message: '──── •💜• ──── 𝐍𝐨𝐰 𝐢𝐭𝐬 𝐭𝐢𝐦𝐞 6:00 𝐏𝐌 ⏳ 𝐁𝐨𝐥𝐨 𝗔𝗟𝗟𝗔𝗛 𝗢 𝗔𝗞𝗕𝗔𝗥 💖 ──── •💜• ────' },
...
module.exports.onLoad = ({ api }) => {
    ...
    messages.forEach(({ time, message }) => {
        ...
        const scheduledTime = moment.tz({ hour: hour24, minute: parseInt(minute, 10) }, 'Pakistan/Karachi').toDate();
